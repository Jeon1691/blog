...
export function TrustChainAsymmetry({ locale = "ko" }: { locale?: Locale }) {
  ...
  return (
    <Figure caption={s.caption}>
      {/* Claim header */}
      <div className="max-w-md mx-auto rounded-md border border-zinc-300 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-900 px-4 py-2.5 text-center">
      ...
      <div className="max-w-md mx-auto rounded-md border border-amber-400 dark:border-amber-700 bg-amber-50 dark:bg-amber-950/40 px-4 py-2 text-center text-sm font-semibold text-amber-800 dark:text-amber-200">
        {s.outcome}
      </div>
