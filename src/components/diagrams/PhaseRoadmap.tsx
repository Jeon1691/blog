    ...
    phases: [
      {
        ...
        duration: "2 weeks",
        title: "Measure",
        body: "Capture baseline: DORA 4 keys + review metrics + churn",
        done: "Baseline dashboard live",
      },
      {
        id: "1",
        duration: "1 month",
        title: "PR template + AI review",
        body: "Enforce Intent/AC/Evidence template, add L2 AI code review",
        done: "Syntax/style comments down 80%",
      },
      {
        id: "2",
        duration: "2 months",
        title: "Spec / Intent pilot",
        body: "Pre-code acceptance-criteria review (1–2 teams)",
      ...
      },
      {
        ...
        duration: "ongoing",
        title: "Human Block Zone",
        body: "Humans gate only critical paths; rest auto-approved",
...
export function PhaseRoadmap({ locale = "ko" }: { locale?: Locale }) {
