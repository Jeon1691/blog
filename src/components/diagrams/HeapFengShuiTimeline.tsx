...
const STRINGS = {
  ko: {
    ...
    events: [
      ...
      { year: "2019", title: "Scudo · kalloc_type", body: "Android 11 Scudo / iOS 15 kalloc_type — 유저·커널 양쪽 익스플로잇 비용 급상승.", era: "mitigation" },
  ...
  en: {
    ...
    events: [
      ...
      { year: "2019", title: "Scudo · kalloc_type", body: "Android 11 Scudo / iOS 15 kalloc_type — sharply raised exploit cost on both sides.", era: "mitigation" },
