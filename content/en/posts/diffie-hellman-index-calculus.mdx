...
→ **For a widely-reused 1024-bit prime, a nation-state could invest in the precomputation and break it** (per the Logjam estimate). An arbitrary 1024-bit safe prime hasn't been publicly broken in general — the threat is that *precomputation amortizes over a reused prime*. This is the direct rationale for NIST/IETF requiring 2048-bit and above.
