...
The claims here aren't just description — I verified them locally, and the full code is in the public [passkey-lab](https://github.com/Jeon1691/passkey-lab) repo.
...
- [ERC-7913: addressless-key signer representation](https://eips.ethereum.org/EIPS/eip-7913)
- [RIP-7212: secp256r1 verification precompile](https://github.com/ethereum/RIPs/blob/master/RIPS/rip-7212.md)
- [EIP-7951: secp256r1 (P-256) verification precompile](https://eips.ethereum.org/EIPS/eip-7951)

**Experiment code**

- [passkey-lab](https://github.com/Jeon1691/passkey-lab) — the hands-on code verifying this post's concepts (Passkey · Secure Enclave · on-chain P-256).
